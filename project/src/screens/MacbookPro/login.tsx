      ...
      <div className="w-[425px] h-[701px]">
        <Card className="w-full h-full rounded-[42px] bg-white shadow-[0_8px_32px_rgba(0,0,0,0.12)] border-0 relative">
          <CardContent className="p-0 flex flex-col items-center h-full">
            ...
            {/* Login button */}
            <Button className="w-[376px] h-16 bg-[#2196f3] hover:bg-[#1976d2] rounded-[120px] shadow-[0_4px_16px_rgba(33,150,243,0.3)] hover:shadow-[0_6px_20px_rgba(33,150,243,0.4)] text-white text-3xl font-normal transition-all duration-200 transform hover:scale-[1.02]">
              MASUK
            </Button>
